...
> Last reconciled with the current source tree: 2026-08-18.
...
- [ ] Verify macOS, Linux, and Windows behavior before a production cutover.
- [ ] Complete one successful five-platform tagged build and install smoke test.
