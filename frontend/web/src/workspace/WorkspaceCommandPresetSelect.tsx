...
import { CliAgentLogo } from '../worker/CliAgentAvatar.js'
...
export const WorkspaceCommandPresetSelect = ({
  ...
  const disabled = externallyDisabled || (presets.length === 0 && !genericSelected)

  useEffect(() => {
    if (externallyDisabled) setOpen(false)
  }, [externallyDisabled])
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div ref={containerRef} className="cli-select group relative">
        <span className="cli-select__leading" aria-hidden>
          <CliAgentLogo commandPresetId={value} fallback={<Terminal size={15} />} size={18} />
        </span>
        <button
          type="button"
        ...
        {open && !externallyDisabled && presets.length > 0 ? (
          <div
            role="listbox"
          ...
          >
              ...
              return (
                ...
                >
                  ...
                  <CliAgentLogo
                    ...
                    fallback={<Terminal aria-hidden size={16} />}
                    size={20}
                  />
                  <span>
                    {preset.displayName}
            ...
            >
              ...
              />
              <Terminal aria-hidden size={18} className="shrink-0 text-ter" />
