...
export const useTerminalRun = (
  ...
  useEffect(() => {
    ...
    let compositionReleaseTimer: number | undefined
    ...
    const cleanupResources = () => {
      ...
      if (compositionReleaseTimer !== undefined) window.clearTimeout(compositionReleaseTimer)
      compositionReleaseTimer = undefined
      wheelFallbackDispose?.()
      wheelFallbackDispose = undefined
    ...
    void Promise.all([
      ...
      if (helperTextarea) {
        ...
        onCompositionEnd = (event: Event) => {
          ...
          if (compositionReleaseTimer !== undefined) {
            window.clearTimeout(compositionReleaseTimer)
          }
