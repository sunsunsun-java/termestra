...
public interface ConfigurationUseCase {
 ...
 List<RoleTemplate> roleTemplates();RoleTemplate roleTemplate(String id);RoleTemplate createRoleTemplate(RoleTemplate value);RoleTemplate updateRoleTemplate(String id,RoleTemplate value);void deleteRoleTemplate(String id);
