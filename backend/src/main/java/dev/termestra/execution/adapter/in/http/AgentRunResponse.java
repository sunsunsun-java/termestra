...
public record AgentRunResponse(@JsonProperty("run_id") String runId,@JsonProperty("agent_id") String agentId,
    ...
    static AgentRunResponse from(AgentRunView view){return new AgentRunResponse(view.runId(),view.agentId(),view.agentName(),view.status(),view.output(),view.exitCode(),view.pid(),view.terminalInputProfile(),view.startupPhase(),view.startupMessage());}
}
